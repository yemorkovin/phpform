...
if(isset($_POST['add_sub'])){
	...
	if(!empty($phone) && !empty($name)){
		...
		if ($_FILES && $_FILES["file"]["error"]== UPLOAD_ERR_OK)
		{
			...
			if(isset($link)) $str_log .= 'Ссылка на файл : '.$link."\n";
			...
			if(isset($link)) $str_html .= '<a href="'.$link.'" >Ссылка на файл</a>';
			...
			$_SESSION['suc'] = 'Ваша заявка принята';
...
<?php }else {?>
<h2 align="center"><?=$_SESSION['suc']?></h2>
<?php } ?>
<script>
function changename(){
